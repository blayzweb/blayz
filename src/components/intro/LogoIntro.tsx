 ...
 *
 * We use an SVG clipPath with the brand logo's custom path data to mask the
 * layers. The layers render inside <foreignObject> components, allowing the CSS
 * procedural textures/gradients to be masked by the brand geometry.
 */
export function LogoIntro() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={wrap}
        className="relative w-[44vw] h-[22vw] sm:w-[32vw] sm:h-[16vw] lg:w-[24rem] lg:h-[12rem] flex items-center justify-center"
      >
        <svg
