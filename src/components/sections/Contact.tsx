      ...
      <div className="relative mt-20">
        ...
        >
          <defs>
            ...
            >
              <path d="M0 12 L6 0 L12 12 Z" fill="var(--blayz-orange)" />
              <path
                d="M6 12 L12 6 L12 12 Z"
                fill="var(--blayz-gold)"
                opacity="0.6"
              />
            </pattern>
          </defs>
          <rect width="240" height="12" fill="url(#sadu-footer)" />
        </svg>

        <div className="mt-10 flex flex-col items-center justify-between gap-4 sm:flex-row">
          <span
            className={`wordmark text-xl text-blayz-ink/40 ${
