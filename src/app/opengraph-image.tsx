...
// Image metadata
export const alt = "Blayz | Crafted with code & culture";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      <div
        style={{
          ...
          position: "relative",
          padding: "80px",
          fontFamily: "monospace", // standard fallbacks for Edge runtime
          border: `12px solid ${brandInk}`,
        }}
      >
        {/* Decorative corner ASCII brackets representing code culture */}
        <div style={{ position: "absolute", top: 20, left: 24, fontSize: 32, color: brandOrange }}>┌</div>
        <div style={{ position: "absolute", top: 20, right: 24, fontSize: 32, color: brandOrange }}>┐</div>
        <div style={{ position: "absolute", bottom: 20, left: 24, fontSize: 32, color: brandOrange }}>└</div>
        <div style={{ position: "absolute", bottom: 20, right: 24, fontSize: 32, color: brandOrange }}>┘</div>
        ...
        >
          ...
          >
            <path d={logoPath} fill={brandOrange} />
          </svg>
